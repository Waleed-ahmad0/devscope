...
export default function AccountProfile() {
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="space-y-2">
                    <SkeletonBox w="100px" h="14px" radius="4px" />
                    <SkeletonBox w="80px" h="24px" radius="6px" />
                  </div>
                  <SkeletonBox w="48px" h="48px" radius="8px" />
                </div>
              </div>
            ))}
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            <div className="lg:col-span-1 space-y-4 sm:space-y-6">
              <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 flex flex-col items-center">
                <SkeletonBox w="80px" h="80px" radius="999px" />
                <div className="mt-4 space-y-2 flex flex-col items-center w-full">
                  <SkeletonBox w="120px" h="20px" radius="4px" />
                  <SkeletonBox w="160px" h="14px" radius="4px" />
                  <SkeletonBox w="60px" h="20px" radius="999px" />
                </div>
              </div>
              <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                ...
                <div className="mt-4 space-y-3">
                  {[0, 1, 2].map((i) => (
                    <SkeletonBox key={i} h="40px" radius="8px" />
                  ))}
                </div>
              </div>
            </div>
            <div className="lg:col-span-3">
              <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
                <SkeletonBox w="150px" h="28px" radius="6px" />
                <div className="mt-2 mb-8">
                  <SkeletonBox w="250px" h="16px" radius="4px" />
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                  {[0, 1].map((i) => (
                    <div key={i}>
                      <SkeletonBox w="80px" h="14px" radius="4px" />
                      <div className="mt-2">
                        <SkeletonBox h="48px" radius="8px" />
                      </div>
                    </div>
                  ))}
                </div>
  ...
  return (
    <div className="h-auto bg-slate-50 flex flex-col">
      <main className="grow">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6 mb-4 sm:mb-6 lg:mb-8">
            <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-5 lg:p-6 shadow-sm border border-slate-200">
              <div className="flex items-center justify-between">
                ...
                <div className="w-10 h-10 sm:w-11 sm:h-11 lg:w-12 lg:h-12 bg-green-50 rounded-lg flex items-center justify-center shrink-0 ml-3">
                  <div
                    className={`w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full ${user?.isActive ? "bg-green-500" : "bg-gray-400"}`}
                  ></div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-5 lg:p-6 shadow-sm border border-slate-200 sm:col-span-2 lg:col-span-1">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  <p className="text-xs sm:text-sm font-medium text-slate-600 truncate">
                    Member Since
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            <div className="lg:col-span-1 space-y-4 sm:space-y-6">
              <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-5 lg:p-6">
                <div className="text-center">
                  <div className="relative inline-block mb-3 sm:mb-4">
                    <div className="w-16 h-16 sm:w-18 sm:h-18 lg:w-20 lg:h-20 rounded-full bg-slate-200 flex items-center justify-center overflow-hidden mx-auto">
                      {(() => {
                        const imageUrl =
                  ...
                  <h2 className="text-base sm:text-lg lg:text-xl font-bold text-slate-900 mb-0.5 sm:mb-1 truncate px-2">
                    {user?.firstName && user?.lastName
                      ? `${user.firstName} ${user.lastName}`
                      : session?.user?.name || "User"}
                  </h2>
                  <p className="text-slate-600 text-xs sm:text-sm mb-3 sm:mb-4 truncate px-2">
                    {session?.user?.email}
                  </p>
                ...
                <div className="flex lg:flex-col gap-1 sm:gap-2 overflow-x-auto lg:overflow-x-visible pb-1 lg:pb-0 -mx-1 px-1 lg:mx-0 lg:px-0">
                  {tabs.map((tab) => (
                    <button
                      ...
                      className={`flex-1 lg:flex-none lg:w-full flex items-center justify-center lg:justify-start space-x-2 sm:space-x-3 px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg text-center lg:text-left transition-colors whitespace-nowrap min-w-[80px] sm:min-w-[100px] lg:min-w-0 ${
                        activeTab === tab.id
                    ...
                    >
                      <tab.icon
                        className={`w-4 h-4 sm:w-5 sm:h-5 ${activeTab === tab.id ? "text-blue-600" : "text-slate-400"}`}
                      />
                  ...
                  <div className="p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6 lg:space-y-8">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 lg:gap-6">
                      <div>
                        ...
                        <div className="p-3 sm:p-4 text-slate-900 bg-slate-50 rounded-lg border border-slate-200 text-sm font-medium">
                    ...
                    <div>
                      ...
                      <div className="p-3 sm:p-4 bg-slate-50 rounded-lg border border-slate-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-3">
                    ...
                    <div className="space-y-3 p-3 sm:p-4">
                      ...
                      <div className="pt-4 sm:pt-6 border-t border-slate-200 flex flex-col sm:flex-row gap-2 sm:gap-3">
                        <button
                  ...
                  <div className="p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6 lg:space-y-8">
                        ...
                        {Object.entries(user?.linkedAccounts || {}).map(
                          ([provider, connected]) =>
                            connected && (
                              <div
                                key={provider}
                                className="flex flex-col sm:flex-row sm:items-center justify-between p-3 sm:p-4 bg-slate-50 rounded-lg border border-slate-200 gap-3 sm:gap-4"
                              >
                                <div className="flex items-center space-x-3 sm:space-x-4">
                                  <div className="w-9 h-9 sm:w-10 sm:h-10 bg-white rounded-lg border border-slate-200 flex items-center justify-center shrink-0">
                                    {getProviderIcon(provider)}
                                  </div>
                                  <div className="min-w-0">
                                    <p className="font-medium text-slate-900 capitalize text-sm sm:text-base truncate">
                    ...
                    {user?.hasPassword && (
                      <div className="pt-4 sm:pt-6 border-t border-slate-200">
                        ...
                        <button className="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 bg-white text-slate-700 font-medium rounded-lg border border-slate-300 hover:bg-slate-50 active:bg-slate-100 transition-colors duration-200 text-sm sm:text-base">
                          Change Password
                        </button>
                      </div>
                    )}
                ...
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200">
                  ...
                  <div className="p-4 sm:p-6 lg:p-8">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
                      <div className="p-4 sm:p-5 lg:p-6 bg-slate-50 rounded-lg border border-slate-200">
                        <h3 className="text-xs sm:text-sm font-medium text-slate-700 mb-1.5 sm:mb-2">
                          Last Login
                        </h3>
