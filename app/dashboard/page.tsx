        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg border border-slate-200 hover:border-blue-300 transition-colors">
            <div className="flex items-center justify-between mb-4">
              <div className="text-sm font-medium text-slate-600">Active Teams</div>
          ...
          <div className="bg-white p-6 rounded-lg border border-slate-200 hover:border-blue-300 transition-colors">
            <div className="flex items-center justify-between mb-4">
              <div className="text-sm font-medium text-slate-600">Your Tasks</div>
              <div className="w-10 h-10 bg-blue-50 rounded-lg flex items-center justify-center">
                <svg className="w-5 h-5 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-lg border border-slate-200">
            <div className="px-6 py-4 border-b border-slate-200 flex items-center justify-between">
              ...
              <a href="/dashboard/projects" className="text-sm font-medium text-blue-600 hover:text-blue-700 transition-colors">
                View all
              </a>
            </div>
            <div className="divide-y divide-slate-100">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-sm text-slate-500">8 tasks • Updated 2h ago</div>
                </div>
                <div className="flex items-center gap-4 shrink-0">
                  <div className="flex -space-x-2">
                    <div className="w-8 h-8 bg-blue-100 rounded-full border-2 border-white flex items-center justify-center">
                      <span className="text-xs font-semibold text-blue-700">SM</span>
                    </div>
                    <div className="w-8 h-8 bg-blue-100 rounded-full border-2 border-white flex items-center justify-center">
                      <span className="text-xs font-semibold text-blue-700">JC</span>
                    </div>
                  ...
                  <div className="w-24">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-medium text-slate-600 w-10 text-right">75%</span>
                    </div>
                  </div>
                </div>
              </a>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-sm text-slate-500">5 tasks • Updated 5h ago</div>
                </div>
                <div className="flex items-center gap-4 shrink-0">
                  <div className="flex -space-x-2">
                    <div className="w-8 h-8 bg-purple-100 rounded-full border-2 border-white flex items-center justify-center">
                      <span className="text-xs font-semibold text-purple-700">ER</span>
                    </div>
                    <div className="w-8 h-8 bg-purple-100 rounded-full border-2 border-white flex items-center justify-center">
                      <span className="text-xs font-semibold text-purple-700">MJ</span>
                    </div>
                  </div>
                  <div className="w-24">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-medium text-slate-600 w-10 text-right">50%</span>
                    </div>
                  </div>
                </div>
              </a>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-sm text-slate-500">12 tasks • Updated 1d ago</div>
                </div>
                <div className="flex items-center gap-4 shrink-0">
                  <div className="flex -space-x-2">
                    <div className="w-8 h-8 bg-indigo-100 rounded-full border-2 border-white flex items-center justify-center">
                      <span className="text-xs font-semibold text-indigo-700">AL</span>
                    </div>
                    <div className="w-8 h-8 bg-indigo-100 rounded-full border-2 border-white flex items-center justify-center">
                      <span className="text-xs font-semibold text-indigo-700">KL</span>
                    </div>
                    <div className="w-8 h-8 bg-slate-100 rounded-full border-2 border-white flex items-center justify-center">
                  ...
                  <div className="w-24">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-medium text-slate-600 w-10 text-right">33%</span>
                    </div>
                  </div>
                </div>
              </a>
              ...
              <div className="p-4 space-y-2">
                <button className="w-full flex items-center gap-3 px-4 py-3 text-left rounded-lg hover:bg-blue-50 transition-colors group border border-transparent hover:border-blue-200">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-slate-500">Create a new project</div>
                  </div>
                </button>
                ...
                <button className="w-full flex items-center gap-3 px-4 py-3 text-left rounded-lg hover:bg-blue-50 transition-colors group border border-transparent hover:border-blue-200">
                  ...
                  <div className="flex-1">
                    <div className="text-sm font-semibold text-slate-900">New Team</div>
                ...
                <button className="w-full flex items-center gap-3 px-4 py-3 text-left rounded-lg hover:bg-blue-50 transition-colors group border border-transparent hover:border-blue-200">
                  ...
                  <div className="flex-1">
                    <div className="text-sm font-semibold text-slate-900">New Task</div>
                    <div className="text-xs text-slate-500">Add to any project</div>
                  </div>
                </button>
              </div>
            </div>
              ...
              <div className="p-4 space-y-4">
                <div className="flex gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm text-slate-900">
                      ...
                      <span className="text-blue-600 font-medium">Homepage Design</span>
                    </p>
                ...
                <div className="flex gap-3">
                  <div className="w-8 h-8 bg-purple-100 rounded-full flex items-center justify-center shrink-0">
                    <span className="text-xs font-semibold text-purple-700">JC</span>
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-sm text-slate-900">
                      <span className="font-medium">James</span> created{' '}
                      <span className="text-blue-600 font-medium">Q1 Planning</span>
                    </p>
                ...
                <div className="flex gap-3">
                  <div className="w-8 h-8 bg-indigo-100 rounded-full flex items-center justify-center shrink-0">
                    <span className="text-xs font-semibold text-indigo-700">ER</span>
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-sm text-slate-900">
                      <span className="font-medium">Emily</span> commented on{' '}
                      <span className="text-blue-600 font-medium">API Integration</span>
                    </p>
                ...
                <div className="flex gap-3">
                  <div className="w-8 h-8 bg-slate-200 rounded-full flex items-center justify-center shrink-0">
                    <span className="text-xs font-semibold text-slate-700">MJ</span>
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-sm text-slate-900">
                      <span className="font-medium">Mike</span> assigned you to{' '}
                      <span className="text-blue-600 font-medium">Code Review</span>
                    </p>
