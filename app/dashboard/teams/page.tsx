        ...
        <div className="max-w-[1100px] mx-auto animate-fade-in-up">
          ...
          <div className="flex items-start justify-between gap-4 mb-8 flex-wrap">
            <div>
              ...
              <p className="text-sm text-slate-500 m-0">Create and manage your teams</p>
            </div>
            <button 
          ...
          {teams.length === 0 ? (
            <div className="bg-white border-[1.5px] border-slate-200 rounded-2xl py-16 px-6 text-center animate-fade-in-up">
              ...
              <h2 className="text-xl font-extrabold text-slate-900 mb-2">No teams yet</h2>
              <p className="text-sm text-slate-500 mb-7">Create your first team to start collaborating with others</p>
              <button 
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3.5 mb-4 mt-1">
                      <div className="w-12 h-12 rounded-xl flex items-center justify-center text-base font-extrabold text-white flex-shrink-0" style={{ background: color }}>
                        {teamInitials(team.name)}
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-base font-bold text-slate-900 m-0 mb-0.5 truncate">{team.name}</p>
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[11.5px] font-bold uppercase tracking-wider ${isOwner ? "bg-blue-50 text-blue-700" : "bg-slate-100 text-slate-600"}`}>
                    ...
                    {/* open button */}
                    <Link href={`/dashboard/teams/${team._id}`} className="mt-auto flex items-center justify-center gap-2 w-full py-2.5 text-[13.5px] font-semibold text-slate-600 bg-slate-50 border-[1.5px] border-slate-200 rounded-xl no-underline transition-all duration-150 hover:bg-blue-50 hover:text-blue-600 hover:border-blue-200">
                      Open Team
